...
// User purchases a course Controller
async function userPurchasesCourse(req, res) {
...
// User Accessing all the courses purchased by him Controller
async function userGetPurchasedCourses(req, res) {
  const userId = req.id;
